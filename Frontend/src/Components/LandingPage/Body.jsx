  ...
  return (
    <div onMouseEnter={changealltohide} className={style.lbody}>
        <div className={style.lb1}>
            <h1 style={{padding:"10px 0 0 0", fontSize: "45px"}}>Find your dream job now</h1>
            <p style={{fontSize: "20px", fontWeight: "bold", paddingBottom: "20px" }}>5 lakh+ jobs for you to explore</p>
