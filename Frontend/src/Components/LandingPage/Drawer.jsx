...
const Drawer = ({ changeflagtofalse }) => {
  return (
    <div className={style.dcont}>
      <div className={style.drawermain}>
        <div onClick={changeflagtofalse} className={style.close}>
          X
        </div>
        <div className={style.header}>
          <p className={style.dlogin}>Login</p>
          <p className={style.dregister}>Register for free</p>
        </div>

        <p className={style.label}>Email ID / Username</p>
        <input
          className={style.dinp}
          type="text"
          placeholder="Enter your active Email ID / Username"
        />
        ...
        <button className={style.dlogbtn}>Login</button>
